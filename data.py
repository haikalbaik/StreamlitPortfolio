# --- DATA FOR ABOUT ME ---
ABOUT_ME_DATA = {
    "header": "Mohd Haikal Mohd Isa",
    "intro": "Hey there! I'm Haikal, an IT & Systems Analyst with over a decade of experience turning complex challenges into smooth, digital solutions.",
    "body": [
        "You might be surprised to learn my journey started deep in the earth, studying Petroleum Geoscience! That's where I first learned how to rock (get it?), consult and solve problems, skills I now happily apply to the world of tech.",
        "I'm all about making things work better, whether it's orchestrating a full-blown digital transformation, streamlining processes with smart automation, or ensuring everyone's on board with new systems.",
        "My superpower? A blend of IT operations, data savvy, and a keen eye for cybersecurity, all wrapped up in a passion for bridging tech with real-world business goals.",
        "Think of me as your go-to person for making digital dreams a reality, efficiently and effectively!"
    ]
}
